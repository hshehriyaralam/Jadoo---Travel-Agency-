...
const Hero = () => {
  return (
    <section className="w-full min-h-screen mx-auto overflow-hidden relative">
      ...
      <div
        className="relative w-full max-w-[1200px] min-h-screen lg:h-[764px] mx-auto  px-4 px-6 
      pt-[100px] lg:pt-[120px]  flex flex-col-reverse lg:flex-row  items-center justify-between  "
      >
        {/* left div */}
        <div
          className="relative z-20 w-full max-w-[630px] 
        ...
        >
          ...
          <div className="relative ">
            ...
            >
              ...
              Travel Agency in Pakistan – Custom Tours, Holidays & Travel Packages
            </h1>
          </div>

          <p className="text-[#5E6282] font-[400] leading-[24px] text-[14px] max-w-[430px] mx-auto lg:mx-0">
            {" "}
            Plan Pakistan and international holidays with Jadoo Travel Agency. Explore tour packages, custom itineraries, flights, hotels, and destination ideas built around your trip.
          </p>

          <div
            className="max-w-[379px] min-h-[60px]  flex flex-col lg:flex-row
            items-center gap-4 mx-auto lg:mx-0"
          >
            <Button
              className="bg-[#F1A501]   hover:bg-[#F1A501]/70 
